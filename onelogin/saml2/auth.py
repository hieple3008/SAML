...
class OneLogin_Saml2_Auth(object):
    ...
    def validate_response_signature(self, request_data, request):
        """
        ...
        return self._validate_signature(request_data, 'SAMLResponse', request)

    def _validate_signature(self, data, saml_type, request, raise_exceptions=False):
        """
        Validate Signature
        ...
        try:
            ...
            signature_node = xml_tree.find(".//{http://www.w3.org/2000/09/xmldsig#}SignatureValue")
            ...
            sign_alg = xml_tree.xpath("//ds:SignatureMethod/@Algorithm", namespaces={"ds": "http://www.w3.org/2000/09/xmldsig#"})
            ...
            query_string = data['query_string'].decode("utf-8")
            check = self._request_data.get('validate_signature_from_qs')
            check = True
            if query_string and check:
